...
console.print("[yellow] -----------------💰HUNT4BITCOIN - 100BITS++.py💰----------------------[/yellow]")
print(' ℹ️Total Bitcoin Addresses Loaded and Checking ℹ️: ',str (line_count))
...
while P<finish:
    ...
    if caddr98 in add or uaddr98 in add or saddr98 in add or bcaddr98 in add or bc1addr98 in add:
        ...
        console.print('[red]Scan:  [' + str(count) + '] [/red]' + '[red] :Remaining:  [' + str(remaining) + '] [/red]','[red]🔁 Total Checked 🔁[' + str(total) + '] [/red]', end='\r')
        #print('Scan: ', count , ' :Remaining: ', str(remaining), ' :Total: ', str(total), '\n :HEX    : ', HEX, '\n :HEX 10%: ', HEX1, '\n :HEX 20%: ', HEX2, '\n :HEX 30%: ', HEX3, '\n :HEX 40%: ', HEX4, '\n :HEX 50%: ', HEX5, '\n :HEX 60%: ', HEX6, '\n :HEX 70%: ', HEX7, '\n :HEX 80%: ', HEX8, '\n :HEX 90%: ', HEX9)
